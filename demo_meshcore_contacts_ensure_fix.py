...
print("   Result: Bot can't resolve pubkey_prefix → sender_id")
print()
...
print("   🔄 [MESHCORE-QUERY] Vérification des contacts...")
print("   ✅ [MESHCORE-QUERY] Contacts disponibles       ← contacts exists but is empty")
print("   📊 [MESHCORE-QUERY] Nombre de contacts: 0      ← EMPTY!")
print("   ⚠️  [MESHCORE-QUERY] Base de contacts VIDE")
print("   🔍 [MESHCORE-QUERY] Appel get_contact_by_key_prefix('143bcd7f1b1f')...")
print("   📋 [MESHCORE-QUERY] Résultat: NoneType = None  ← NOT FOUND")
print("   ⚠️  [MESHCORE-QUERY] Aucun contact trouvé")
print()
print("❌ PROBLEM: ensure_contacts() exists but was NEVER CALLED")
...
print()
print("query_contact_by_pubkey_prefix('143bcd7f1b1f'):")
print("   🔄 [MESHCORE-QUERY] Appel ensure_contacts()...   ← FIX #1: Actually call it!")
print("   ✅ [MESHCORE-QUERY] ensure_contacts() terminé")
print("   ✅ [MESHCORE-QUERY] Contacts disponibles après ensure_contacts()")
print("   📊 [MESHCORE-QUERY] Nombre de contacts: 19     ← NOW POPULATED!")
print("   🔍 [MESHCORE-QUERY] Appel get_contact_by_key_prefix('143bcd7f1b1f')...")
print("   📋 [MESHCORE-QUERY] Résultat: dict = {contact info}")
print("   ✅ [MESHCORE-QUERY] Contact trouvé: Tigro T1000E (0x143bcd7f)")
print("   💾 [MESHCORE-QUERY] Contact ajouté à node_manager")
print()
print("✅ FIXED: ensure_contacts() is now called, contacts are loaded!")
print()
...
print("=" * 70)
print()
print("1. ✅ meshcore_cli_wrapper.py::query_contact_by_pubkey_prefix()")
print("   ")
print("   BEFORE:")
print("   -------")
print("   if hasattr(self.meshcore, 'ensure_contacts'):")
print("       debug_print('Vérification des contacts...')")
print("       # PROBLEM: Never called ensure_contacts()")
print("       if self.meshcore.contacts is None:")
print("           debug_print('Contacts non chargés')")
print()
print("   AFTER:")
print("   ------")
print("   if hasattr(self.meshcore, 'ensure_contacts'):")
...
print("=" * 70)
print()
print("1. 🔄 ensure_contacts() actively loads contacts from device")
...
print()
print("Before fix:")
print("   ❌ Bot: 0 contacts")
print("   ❌ query_contact_by_pubkey_prefix() returns None")
print("   ❌ Can't respond to DM messages")
print()
print("After fix:")
print("   ✅ Bot: 19 contacts (same as meshcore-cli)")
print("   ✅ query_contact_by_pubkey_prefix() returns contact info")
print("   ✅ Can respond to DM messages properly")
print()
...
print("  [ ] Bot logs show 'ensure_contacts() terminé'")
print("  [ ] Bot logs show '19 contact(s) synchronisés' (or similar count)")
print("  [ ] Incoming DM with /power command is processed")
print("  [ ] Bot resolves pubkey_prefix → sender_id")
