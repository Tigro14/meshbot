...
print("   ⚠️  sync_contacts() not available")
print()
...
print("   Port: /dev/ttyACM0")
print("   Baudrate: 115200")
print("   Debug mode: DISABLED  ⬅️ NEW: Shows debug status")
print()
print("🔌 Connecting to MeshCore device...")
print("✅ Connected successfully!")
print()
...
print("   Send a message to this device to test")
print("   Press Ctrl+C to exit")
print("   (Use --debug flag for verbose meshcore library output)  ⬅️ NEW: Helpful hint")
print("============================================================")
print()
print(f"[{datetime.now().strftime('%H:%M:%S')}] 💓 Monitor active | Messages received: 0  ⬅️ NEW: Heartbeat every 30s")
print()
print(f"[{datetime.now().strftime('%H:%M:%S')}] 💓 Monitor active | Messages received: 0  ⬅️ NEW: Shows it's still running")
print()
...
print("   Port: /dev/ttyACM0")
print("   Baudrate: 115200")
print("   Debug mode: ENABLED  ⬅️ NEW: Shows debug is on")
print()
print("🔌 Connecting to MeshCore device...")
print("DEBUG:meshcore:Opening serial port /dev/ttyACM0  ⬅️ Internal meshcore logs")
...
print("📡 Setting up event subscription...")
print("   Using: meshcore.dispatcher.subscribe()")
print("DEBUG:meshcore:Subscribing to CONTACT_MSG_RECV  ⬅️ Internal meshcore logs")
print("✅ Subscribed to CONTACT_MSG_RECV events")
print()
print("DEBUG:meshcore:Polling for messages...  ⬅️ Continuous internal activity logs")
...
print("============================================================")
print()
print(f"[{datetime.now().strftime('%H:%M:%S')}] 💓 Monitor active | Messages received: 0")
