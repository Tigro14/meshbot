...
class UtilityCommands:
    ...
    def handle_weather(self, message, sender_id, sender_info):
        ...
        if subcommand == 'rain':
            # Graphe de précipitations (Mesh: 15h ultra-compact pour limites LoRa ~180 chars)
            ...
            weather_data = get_rain_graph(location, days=days, max_hours=15, compact_mode=True, persistence=persistence, start_at_current_time=True)
